...
<html>
    ...
    <center>
        <table >
            ...
            <form action="esquema" method="post"> 
                <tr >
        ...
        <table >
            <tr>
                <td> <a  href="Tabla.jsp" ><input style="background-color: #33ffff"  class="submit" type="submit" name="venta_registrada" value="Crear Tabla" /> </td>
